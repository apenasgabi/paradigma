...
public class SpotifyApp {
    ...
    public static SpotifyMusic createMusic(Scanner dataScanner){
        ...
        return new SpotifyMusic(title, duration, songwriters, interpreters, genre);
    }

    public static SpotifyPodcast createPodcast(Scanner dataScanner){
        String title;
        int duration;
        String presenter;
        String review;
        ...
        return new SpotifyPodcast(title, duration, presenter, review);
    }

    public static SpotifyAudiobook createAudioook(Scanner dataScanner){
        Scanner stringCutter;
        String title;
        int duration;
        ...
        return new SpotifyAudiobook(title, duration, storyteller, synopsis, authors, publisher);
    }

    public static void addToPlaylist(Scanner dataScanner, String playlistTitle, SpotifyMenu menu){
    ...
    public static void showPlaylistContent(Scanner dataScanner, String playlistTitle, SpotifyMenu menu){
        ...
        if(!filteredList.isEmpty()){
            ...
            System.out.println("========================================================================================");
            for (SpotifyContent SpotifyContent : filteredList){
                System.out.printf("%d | %s\n", counter, SpotifyContent.toString());
                counter += 1;
            }
        }else{
    ...
    public static void createPlaylist(Scanner dataScanner, SpotifyMenu menu){
    ...
    public static void deletePlaylist(Scanner dataScanner, SpotifyMenu menu){
        String playlistTitle;
    ...
    public static void showPlaylists(Scanner dataScanner, SpotifyMenu menu){
        int counter =1;
    ...
    public static void main(String[] args){
        SpotifyMenu myMenu = new SpotifyMenu();
        ...
        clearTerminal();
        System.out.println("Olá, seja bem vindo ao Spotify!\n");
        pressEnter(dataScanner);
